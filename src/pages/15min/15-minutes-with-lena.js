...
class fifteenMinWithLena extends React.Component {
/**
* variable declaration
*/
  constructor(props) {
    super(props);
    const myData = require('../../locale/'+props.url.query.lang+'/15-minutes-with-lena.json');
    this.state = {
      url: props,
      ...
      <Layout currentPath={this.state.url && this.state.url.pathname} lang={this.state.lang}>
        <style jsx>{`
          .background-header-banner {
            background: url("https://i.rosefieldwatches.com/products/15min/15-min-lena/main-start-banner.jpg")no-repeat top center;
            lost-column: 12/12;
        ...
        <div className="common-row">
          <div className="intro-section">
            ...
            <p dangerouslySetInnerHTML={{ __html: this.state.res_data.IntroText }}></p>
          </div>
        </div>
        <div className="common-row">
          <div className="three-image-section">
            <div className="image-wrapper">
              <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-1.jpg" alt="" />
            </div>
            <div className="image-wrapper">
              <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-2.jpg" alt="" />
            </div>
            <div className="image-wrapper">
              <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-3.jpg" alt="" />
            </div>
          </div>
          <div className="mobile-three-section">
            <Slider {...settings}>
              <div><img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-1.jpg" alt="" /></div>
              <div><img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-2.jpg" alt="" /></div>
              <div><img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/trio-3.jpg" alt="" /></div>
            </Slider>
          </div>
        </div>
        <div className="common-row">
        ...
        <div className="common-row two-image-main-wrapper">
          <div className="two-image-section">
            <div className="image-wrapper">
              <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/couple-1.jpg" alt="" />
            </div>
            <div className="image-wrapper">
              <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/couple-2.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div className="common-row">
          <div className="product-section">
            <div className="product-image-section">
              <a href="">
                <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/rose-black.png" alt="" />
              </a>
        ...
        <div className="common-row close-image-section">
          <img src="https://i.rosefieldwatches.com/products/15min/15-min-lena/main-close.jpg" alt="" />
...
export default withData(fifteenMinWithLena);
