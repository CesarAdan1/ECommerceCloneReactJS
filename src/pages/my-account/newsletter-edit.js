  ...
  <Layout currentPath={url && url.pathname} lang={url.query.lang}>
    ...
    <div className="common-row">
      <div className="account-left-section">
        <h1>Hi Demo Dev</h1>
        <ul>
          <li><a href="/my-account" className="active-tab">Account Dashboard</a></li>
      ...
      <div className="account-right-section">
        <div className="newsletter-main">
          ...
          <div>
            <input type="checkbox" name="is_subscribed" id="subscription" value="1" checked="checked" />
            <label htmlFor="subscription">General Subscription</label>
          </div>
        </div>
      </div>
    </div>
